...
class PokemonValidator:
    ...
    def __init__(self):
        """Initialize the Pokemon validator using centralized translation data"""
        self.pokemon_name_translations = POKEMON_NAME_TRANSLATIONS
        self.form_corrections = FORM_CORRECTIONS
        self.paradox_pokemon = PARADOX_POKEMON
        self.signature_moves = SIGNATURE_MOVES
        self.stat_abbreviations = EV_STAT_TRANSLATIONS
